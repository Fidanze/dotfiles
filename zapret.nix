    ...
    systemd.services.zapret = {
      ...
      serviceConfig = {
        ...
        EnvironmentFile = pkgs.writeText "zapret-environment" ''
                    ...
                    DISABLE_IPV6=1
                    INIT_APPLY_FW=1
                    NFQWS_OPT_DESYNC="--hostlist=${./list-discord.txt} --dpi-desync=syndata,fake,split2 --dpi-desync-fooling=md5sig"
                    ...
                    #NFQWS_OPT_DESYNC="--dpi-desync=split2"
          	  		...
          	  		#NFQWS_OPT_DESYNC="--dpi-desync=fake,disorder2 --dpi-desync-split-pos=1 --dpi-desync-ttl=0 --dpi-desync-fooling=md5sig,badsum --dpi-desync-repeats=6 --dpi-desync-any-protocol --dpi-desync-cutoff=d4 --dpi-desync-fake-tls=${./tls_clienthello_www_google_com.bin} "
        '';
      };
    };
    services = {
